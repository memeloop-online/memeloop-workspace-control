...
import type { OrganizationUsageSummary, QuotaResources } from "../src/types";
...
const summary: OrganizationUsageSummary = {
  ...
  requested: { cpu_millis: 64_000, memory_mib: 131_072, disk_gib: 2_048, gpu_count: 0, temporary_storage_gib: 1_280 },
  actual: { cpu_millis: 23_500, memory_mib: 65_536, disk_bytes: 768 * 1024 ** 3, temporary_bytes: 512 * 1024 ** 3 }, observed_at: 1_789_000_000,
...
const quota: QuotaResources = { cpu_millis: 96_000, memory_mib: 196_608, disk_gib: 4_096, gpu_count: 0, temporary_storage_gib: 2_048 };
