...
const useStyles = makeStyles({
  ...
  topbar: {
    ...
    backgroundColor: tokens.colorNeutralBackground1,
    "@media (max-width: 900px)": { paddingInline: tokens.spacingHorizontalL },
    "@media (max-width: 560px)": { alignItems: "center", paddingBlock: tokens.spacingVerticalM },
  },
  org: {
    minWidth: 0,
    display: "grid",
    gap: tokens.spacingVerticalXXS,
    "@media (max-width: 560px)": { flex: "1 1 auto", maxWidth: "calc(100% - 116px)" },
  },
  ...
  topbarActions: {
    ...
    "@media (max-width: 560px)": { gap: tokens.spacingHorizontalXS },
  },
  userTrigger: {
    maxWidth: "240px",
    justifyContent: "flex-start",
    textAlign: "left",
    "@media (max-width: 560px)": { maxWidth: "48px", paddingInline: tokens.spacingHorizontalXS },
  },
  userTriggerContent: {
    minWidth: 0,
    display: "grid",
  ...
  loginPage: {
    ...
    backgroundColor: tokens.colorNeutralBackground2,
    "@media (max-width: 560px)": { padding: tokens.spacingHorizontalS },
  },
  loginCard: { width: "min(440px, 100%)", "@media (max-width: 560px)": { boxShadow: "none" } },
  ...
  mobileMenu: { display: "none", "@media (max-width: 900px)": { display: "inline-flex" } },
  desktopOnly: { display: "inline-flex", "@media (max-width: 900px)": { display: "none" } },
});
