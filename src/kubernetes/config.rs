...
pub fn resource_builder(config: &AppConfig) -> Result<ResourceBuilder, io::Error> {
    ...
    let buildkit_image = std::env::var("MWC_BUILDKIT_IMAGE").unwrap_or_else(|_| {
        "moby/buildkit:v0.33.0-rootless@sha256:80b15f0735e87bab7bf59ec4d695dfb4a7cfb25521cf56dc75d6f256285b63ef".to_owned()
    });
    ...
    let jump_host_namespace = std::env::var("MWC_JUMP_HOST_NAMESPACE")
        .unwrap_or_else(|_| crate::workspace_runtime::WORKSPACE_NAMESPACE.to_owned());
