...
pub(super) fn operational_response(error: ApiError) -> ErrorResponse {
    match error {
...
pub(super) fn injection_response(error: crate::injections::InjectionError) -> ErrorResponse {
    match error {
...
pub(super) fn storage_response(error: StorageError) -> ErrorResponse {
...
pub(super) fn response(status: StatusCode, code: &'static str, message: &str) -> ErrorResponse {
